...
export function buildContinueUserPrompt(input: ContinueAnalysisInput): string {
  ...
  lines.push(
    ...
    "Если текущий decisionStatus разбора выше = resolved — ставь unresolved ТОЛЬКО если новое сообщение создаёт подлинную новую неопределённость, способную изменить маршрут. Не открывай решение заново из-за мелкого уточнения, свершившегося исполнения, течения времени или выдуманного нового риска.",
