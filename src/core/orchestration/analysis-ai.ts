...
export function buildContinueUserPrompt(input: ContinueAnalysisInput): string {
  ...
  lines.push(
    "",
    "Обнови весь разбор (decisionStatus, все пять секций, priority, factCheck, caseMemory и при resolved — decisionChallenge) с учётом памяти кейса, истории и нового сообщения.",
